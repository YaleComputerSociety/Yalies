...
### Original Components
- `yalies-web` - Next.js frontend
- `yalies-backend` - Express backend
- `yalies-scraper` - Data scraper
- `yalies-shared` - Shared types and utilities

### New Unified Backend (Y/CS Unified Services)
- `apps/` - Application services
  - `api-gateway/` - Unified API gateway
  - `scraper/` - Scraper service with scheduler
  - `services/` - Domain services (coursetable, yaleims, yalies)
- `packages/` - Shared packages
  ...
  - `scraper-lib/` - Scraper utilities
  - `types/` - Shared TypeScript types
- `scripts/` - Python scraping scripts
- `supabase/` - Database migrations

## Quick Start (New Unified Backend)
...
## Getting Started (Original Setup)
